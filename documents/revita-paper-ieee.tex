...
\item Dữ liệu huấn luyện: $\sim$200 k hồ sơ MIMIC-IV được chia thành ba tập với tỷ lệ 70\%/15\%/15\% cho train/validation/test. Việc chia dữ liệu được thực hiện theo \texttt{subject\_id} để đảm bảo không có bệnh nhân nào xuất hiện ở nhiều tập khác nhau, tránh hiện tượng rò rỉ dữ liệu.
